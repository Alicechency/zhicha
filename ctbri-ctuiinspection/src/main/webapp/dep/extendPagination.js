...
(function ($) {
    $.fn.extendPagination = function (options) {
        ...
        if (defaults.showPage == '') {
            defaults.showPage = '5';
        } else if (Number(defaults.showPage) <= 0)defaults.showPage = '5';
        if (defaults.limit == '') {
            defaults.limit = '5';
        ...
        if (totalPage > 0) {
            ...
            html.push(' <li class="previous"><a href="#"><img src="'+imgPath+'/turn-left.png" style="width: 15px;height: 15px"></a></li>');
            ...
            html.push('<li class="disabled hidden"><a href="#">...</a></li>');
            html.push('<li class="next"><a href="#"><img src="'+imgPath+'/turn-right.png" style="width: 15px;height: 15px"></a></li></ul>');
            $(this).html(html.join(''));
